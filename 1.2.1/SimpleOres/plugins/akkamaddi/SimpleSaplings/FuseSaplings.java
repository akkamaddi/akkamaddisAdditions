package SimpleOres.plugins.akkamaddi.SimpleSaplings;
...
public class FuseSaplings
{
    ...
    @SidedProxy(clientSide = "SimpleOres.plugins.akkamaddi.SimpleSaplings.ClientProxy", serverSide = "SimpleOres.plugins.akkamaddi.SimpleSaplings.CommonProxy")
