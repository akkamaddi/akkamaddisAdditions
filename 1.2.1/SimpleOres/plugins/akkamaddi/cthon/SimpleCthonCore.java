...
import SimpleOres.plugins.akkamaddi.cthon.CthonOreBlock;;
...
public class SimpleCthonCore
{
    ...
    @SidedProxy(clientSide = "SimpleOres.plugins.akkamaddi.cthon.ClientProxy", serverSide = "SimpleOres.plugins.akkamaddi.cthon.CommonProxy")
...
// Tab
    ...
    public void preInit(FMLPreInitializationEvent event)
    {
        ...
        cthonIngot = new SimpleIngot(cthonIngotID, "simplecthon", SimpleCthonCore.tabAkkamaddiCthon).setUnlocalizedName("cthonIngot");
        cthonElutriatedChunk = new SimpleIngot(cthonElutriatedChunkID, "simplecthon", SimpleCthonCore.tabAkkamaddiCthon).setUnlocalizedName("cthonElutriatedChunk");
        cthonMephiticChunk = new SimpleIngot(cthonMephiticChunkID, "simplecthon", SimpleCthonCore.tabAkkamaddiCthon).setUnlocalizedName("cthonMephiticChunk");
        cthonSword = new SimpleSword(cthonSwordID, toolCthon, "simplecthon", SimpleCthonCore.tabAkkamaddiCthon).setUnlocalizedName("cthonSword");
        cthonShovel = new SimpleShovel(cthonShovelID, toolCthon, "simplecthon", SimpleCthonCore.tabAkkamaddiCthon).setUnlocalizedName("cthonShovel");
        cthonAxe = new SimpleAxe(cthonAxeID, toolCthon, "simplecthon", SimpleCthonCore.tabAkkamaddiCthon).setUnlocalizedName("cthonAxe");
        cthonPickaxe = new SimplePickaxe(cthonPickaxeID, toolCthon, "simplecthon", SimpleCthonCore.tabAkkamaddiCthon).setUnlocalizedName("cthonPickaxe");
        cthonHoe = new SimpleHoe(cthonHoeID, toolCthon, "simplecthon", SimpleCthonCore.tabAkkamaddiCthon).setUnlocalizedName("cthonHoe");
        cthonHelm = new SimpleArmor(cthonHelmID, armorCthon, rendererCthon, 0, "cthon", "simplecthon", SimpleCthonCore.tabAkkamaddiCthon).setUnlocalizedName("cthonHelm");
        cthonChest = new SimpleArmor(cthonChestID, armorCthon, rendererCthon, 1, "cthon", "simplecthon", SimpleCthonCore.tabAkkamaddiCthon).setUnlocalizedName("cthonChest");
        cthonLegs = new SimpleArmor(cthonLegsID, armorCthon, rendererCthon, 2, "cthon", "simplecthon", SimpleCthonCore.tabAkkamaddiCthon).setUnlocalizedName("cthonLegs");
        cthonBoots = new SimpleArmor(cthonBootsID, armorCthon, rendererCthon, 3, "cthon", "simplecthon", SimpleCthonCore.tabAkkamaddiCthon).setUnlocalizedName("cthonBoots");
        
        // define blocks        
        blockCthon = new SimpleOre(blockCthonID, Material.iron, "simplecthon", SimpleCthonCore.tabAkkamaddiCthon)
        ...
        // loot
        HandlerLoot.lootHandler().addLoot("pyramidDesertyChest", cthonIngot, 1, 1, 1);
        HandlerLoot.lootHandler().addLoot("pyramidDesertyChest", cthonPickaxe, 1, 1, 1);
        HandlerLoot.lootHandler().addLoot("pyramidJungleChest", cthonIngot, 1, 1, 1);
        HandlerLoot.lootHandler().addLoot("pyramidJungleChest", cthonPickaxe, 1, 1, 1);
        HandlerLoot.lootHandler().addLoot("dungeonChest", cthonIngot, 1, 1, 1);
        HandlerLoot.lootHandler().addLoot("dungeonChest", cthonShovel, 1, 1, 1);
