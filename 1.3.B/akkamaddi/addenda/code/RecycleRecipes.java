...
public class RecycleRecipes
{
    ...
    public static void doRecycleRecipes()
    {
        ...
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ItemArmor.helmetDiamond, 1, WILDCARD_VALUE), new ItemStack(Block.oreCoal), new ItemStack(Item.bucketLava), new ItemStack(Block.oreDiamond), 20.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ItemArmor.plateDiamond, 1, WILDCARD_VALUE), new ItemStack(Block.oreCoal, 2, 0), new ItemStack(Item.bucketLava), new ItemStack(Block.oreDiamond, 2, 0), 40.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ItemArmor.legsDiamond, 1, WILDCARD_VALUE), new ItemStack(Block.oreCoal, 2, 0), new ItemStack(Item.bucketLava), new ItemStack(Block.oreDiamond, 2, 0), 40.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ItemArmor.bootsDiamond, 1, WILDCARD_VALUE), new ItemStack(Block.oreCoal), new ItemStack(Item.bucketLava), new ItemStack(Block.oreDiamond), 20.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(Item.swordDiamond, 1, WILDCARD_VALUE), new ItemStack(Block.oreCoal), new ItemStack(Item.bucketLava), new ItemStack(Block.oreDiamond), 20.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(Item.shovelDiamond, 1, WILDCARD_VALUE), new ItemStack(Block.oreCoal), new ItemStack(Item.bucketLava), new ItemStack(Block.oreDiamond), 20.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(Item.pickaxeDiamond, 1, WILDCARD_VALUE), new ItemStack(Block.oreCoal), new ItemStack(Item.bucketLava), new ItemStack(Block.oreDiamond), 20.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(Item.axeDiamond, 1, WILDCARD_VALUE), new ItemStack(Block.oreCoal), new ItemStack(Item.bucketLava), new ItemStack(Block.oreDiamond), 20.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(Item.hoeDiamond, 1, WILDCARD_VALUE), new ItemStack(Block.oreCoal), new ItemStack(Item.bucketLava), new ItemStack(Block.oreDiamond), 20.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(Item.horseArmorDiamond, 1, WILDCARD_VALUE), new ItemStack(Block.oreCoal, 2, 0), new ItemStack(Item.bucketLava), new ItemStack(Block.oreDiamond, 2, 0), 20.0F);
        //
        // recycle your Copper
        ...
        //
        // recycle your Onyx
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(CoreHelper.coreContent.onyxHelm, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack), new ItemStack(Item.bucketLava), new ItemStack(CoreHelper.coreContent.onyxOre), 20.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(CoreHelper.coreContent.onyxChest, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack, 2, 0), new ItemStack(Item.bucketLava), new ItemStack(CoreHelper.coreContent.onyxOre, 2, 0), 40.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(CoreHelper.coreContent.onyxLegs, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack, 2, 0), new ItemStack(Item.bucketLava), new ItemStack(CoreHelper.coreContent.onyxOre, 2, 0), 40.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(CoreHelper.coreContent.onyxBoots, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack), new ItemStack(Item.bucketLava), new ItemStack(CoreHelper.coreContent.onyxOre), 20.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(CoreHelper.coreContent.onyxSword, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack), new ItemStack(Item.bucketLava), new ItemStack(CoreHelper.coreContent.onyxOre), 20.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(CoreHelper.coreContent.onyxShovel, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack), new ItemStack(Item.bucketLava), new ItemStack(CoreHelper.coreContent.onyxOre), 20.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(CoreHelper.coreContent.onyxPick, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack), new ItemStack(Item.bucketLava), new ItemStack(CoreHelper.coreContent.onyxOre), 20.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(CoreHelper.coreContent.onyxAxe, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack), new ItemStack(Item.bucketLava), new ItemStack(CoreHelper.coreContent.onyxOre), 20.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(CoreHelper.coreContent.onyxHoe, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack), new ItemStack(Item.bucketLava), new ItemStack(CoreHelper.coreContent.onyxOre), 20.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(CoreHelper.coreContent.onyxBow, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack), new ItemStack(Item.bucketLava), new ItemStack(CoreHelper.coreContent.onyxOre), 20.0F);
        // extra Onyx recycling
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(CoreHelper.coreContent.onyxDoorItem), new ItemStack(Block.netherrack), new ItemStack(Item.bucketLava), new ItemStack(CoreHelper.coreContent.onyxOre), 20.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(CoreHelper.coreContent.onyxRod), new ItemStack(Block.netherrack), new ItemStack(Item.bucketLava), new ItemStack(CoreHelper.coreContent.onyxOre), 20.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(CoreHelper.coreContent.onyxShears, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack), new ItemStack(Item.bucketLava), new ItemStack(CoreHelper.coreContent.onyxOre), 20.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(CoreHelper.coreContent.onyxFurnace), new ItemStack(Block.netherrack, 2, 0), new ItemStack(Item.bucketLava), new ItemStack(CoreHelper.coreContent.onyxOre, 2, 0), 40.0F);
        //
        // recycle your Bronze
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(soAlloy.bronzeHelm, 1, WILDCARD_VALUE), new ItemStack(Block.gravel),  new ItemStack(Item.coal, 1, WILDCARD_VALUE), new ItemStack(soAlloy.largeBronzeChunk), 10.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(soAlloy.bronzeChest, 1, WILDCARD_VALUE), new ItemStack(Block.gravel, 2, 0),  new ItemStack(Item.coal, 2, WILDCARD_VALUE), new ItemStack(soAlloy.largeBronzeChunk, 2, 0), 20.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(soAlloy.bronzeLegs, 1, WILDCARD_VALUE), new ItemStack(Block.gravel, 2, 0),  new ItemStack(Item.coal, 2, WILDCARD_VALUE), new ItemStack(soAlloy.largeBronzeChunk, 2, 0), 20.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(soAlloy.bronzeBoots, 1, WILDCARD_VALUE), new ItemStack(Block.gravel),  new ItemStack(Item.coal, 1, WILDCARD_VALUE), new ItemStack(soAlloy.largeBronzeChunk), 10.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(soAlloy.bronzeSword, 1, WILDCARD_VALUE), new ItemStack(Block.gravel),  new ItemStack(Item.coal, 1, WILDCARD_VALUE), new ItemStack(soAlloy.largeBronzeChunk), 10.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(soAlloy.bronzeShovel, 1, WILDCARD_VALUE), new ItemStack(Block.gravel),  new ItemStack(Item.coal, 1, WILDCARD_VALUE), new ItemStack(soAlloy.largeBronzeChunk), 10.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(soAlloy.bronzePick, 1, WILDCARD_VALUE), new ItemStack(Block.gravel),  new ItemStack(Item.coal, 1, WILDCARD_VALUE), new ItemStack(soAlloy.largeBronzeChunk), 10.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(soAlloy.bronzePick, 1, WILDCARD_VALUE), new ItemStack(Block.gravel),  new ItemStack(Item.coal, 1, WILDCARD_VALUE), new ItemStack(soAlloy.largeBronzeChunk), 10.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(soAlloy.bronzeAxe, 1, WILDCARD_VALUE), new ItemStack(Block.gravel),  new ItemStack(Item.coal, 1, WILDCARD_VALUE), new ItemStack(soAlloy.largeBronzeChunk), 10.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(soAlloy.bronzeHoe, 1, WILDCARD_VALUE), new ItemStack(Block.gravel),  new ItemStack(Item.coal, 1, WILDCARD_VALUE), new ItemStack(soAlloy.largeBronzeChunk), 10.0F);
        //
        // recycle your Thyrium
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(soAlloy.thyriumHelm, 1, WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.bucketLava), new ItemStack(soAlloy.largeThyriumChunk), 15.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(soAlloy.thyriumChest, 1, WILDCARD_VALUE), new ItemStack(Block.gravel, 2, 0), new ItemStack(Item.bucketLava), new ItemStack(soAlloy.largeThyriumChunk, 2, 0), 15.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(soAlloy.thyriumLegs, 1, WILDCARD_VALUE), new ItemStack(Block.gravel, 2, 0), new ItemStack(Item.bucketLava), new ItemStack(soAlloy.largeThyriumChunk, 2, 0), 15.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(soAlloy.thyriumBoots, 1, WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.bucketLava), new ItemStack(soAlloy.largeThyriumChunk), 15.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(soAlloy.thyriumSword, 1, WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.bucketLava), new ItemStack(soAlloy.largeThyriumChunk), 15.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(soAlloy.thyriumShovel, 1, WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.bucketLava), new ItemStack(soAlloy.largeThyriumChunk), 15.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(soAlloy.thyriumPick, 1, WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.bucketLava), new ItemStack(soAlloy.largeThyriumChunk), 15.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(soAlloy.thyriumPick, 1, WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.bucketLava), new ItemStack(soAlloy.largeThyriumChunk), 15.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(soAlloy.thyriumAxe, 1, WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.bucketLava), new ItemStack(soAlloy.largeThyriumChunk), 15.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(soAlloy.thyriumHoe, 1, WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.bucketLava), new ItemStack(soAlloy.largeThyriumChunk), 15.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(soAlloy.thyriumBow, 1, WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.bucketLava), new ItemStack(soAlloy.largeThyriumChunk), 15.0F);
        // extra Thyrium recycling
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(soAlloy.thyriumRod), new ItemStack(Block.gravel), new ItemStack(Item.bucketLava), new ItemStack(soAlloy.largeThyriumChunk), 15.0F);
        //
        // recycle your Sinisite
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(soAlloy.sinisiteHelm, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack), new ItemStack(Item.bucketLava), new ItemStack(soAlloy.largeSinisiteChunk), 20.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(soAlloy.sinisiteChest, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack, 2, 0), new ItemStack(Item.bucketLava), new ItemStack(soAlloy.largeSinisiteChunk, 2, 0), 20.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(soAlloy.sinisiteLegs, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack, 2, 0), new ItemStack(Item.bucketLava), new ItemStack(soAlloy.largeSinisiteChunk, 2, 0), 20.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(soAlloy.sinisiteBoots, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack), new ItemStack(Item.bucketLava), new ItemStack(soAlloy.largeSinisiteChunk), 20.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(soAlloy.sinisiteSword, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack), new ItemStack(Item.bucketLava), new ItemStack(soAlloy.largeSinisiteChunk), 20.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(soAlloy.sinisiteShovel, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack), new ItemStack(Item.bucketLava), new ItemStack(soAlloy.largeSinisiteChunk), 20.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(soAlloy.sinisitePick, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack), new ItemStack(Item.bucketLava), new ItemStack(soAlloy.largeSinisiteChunk), 20.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(soAlloy.sinisiteAxe, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack), new ItemStack(Item.bucketLava), new ItemStack(soAlloy.largeSinisiteChunk), 20.0F);
        FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(soAlloy.sinisiteHoe, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack), new ItemStack(Item.bucketLava), new ItemStack(soAlloy.largeSinisiteChunk), 20.0F);
