...
{
    public OssidSeeds(int id, int parentId, int soilId)
    {
    ...
    {
        this.itemIcon = ir.registerIcon("ashenwheat:ossidSeeds");
    }
                             ...
                             int x, int y, int z, int par7, float par8, float par9, float par10)
    {
        ...
        else if (player.canPlayerEdit(x, y, z, par7, stack) && player.canPlayerEdit(x, y + 1 , z, par7, stack))
        {
            ...
            {
                world.setBlock(x, y + 1, z, AshenWheatCore.ossidRootCrop.blockID);
                --stack.stackSize;
                return true;
            }
            else
    ...
    {
        return AshenWheatCore.ossidRootCrop.blockID;
    }
