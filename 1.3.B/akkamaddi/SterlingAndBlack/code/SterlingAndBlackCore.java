...
public class SterlingAndBlackCore
{
     ...
     */
    public static EnumArmorMaterial armorSterlingSteel = EnumHelper.addArmorMaterial("STERLINGSTEEL", 18, new int[] {3, 6, 5, 3}, 28);
    ...
    public static EnumToolMaterial toolSterlingSteel = EnumHelper.addToolMaterial("STERLINGSTEEL", 3, 660, 10.0F, 2, 26);
    ...
    public void preInit(FMLPreInitializationEvent event)
    {
        ...
        mediumSterlingSteelChunkItem = new SimpleIngot(mediumSterlingSteelChunkItemID).modId("sterlingandblack").setCreativeTab(SterlingAndBlackCore.tabAkkamaddiSterling).setUnlocalizedName("mediumSterlingSteelChunkItem");
        largeSterlingSteelChunkItem = new SimpleIngot(largeSterlingSteelChunkItemID).modId("sterlingandblack").setCreativeTab(SterlingAndBlackCore.tabAkkamaddiSterling).setUnlocalizedName("largeSterlingSteelChunkItem");
        sterlingSteelSword = new SimpleSword(sterlingSteelSwordID, toolSterlingSteel).modId("sterlingandblack").setCreativeTab(SterlingAndBlackCore.tabAkkamaddiSterling).setUnlocalizedName("sterlingSteelSword");
        sterlingSteelShovel = new SimpleShovel(sterlingSteelShovelID, toolSterlingSteel).modId("sterlingandblack").setCreativeTab(SterlingAndBlackCore.tabAkkamaddiSterling).setUnlocalizedName("sterlingSteelShovel");
        sterlingSteelAxe = new SimpleAxe(sterlingSteelAxeID, toolSterlingSteel).modId("sterlingandblack").setCreativeTab(SterlingAndBlackCore.tabAkkamaddiSterling).setUnlocalizedName("sterlingSteelAxe");
        sterlingSteelPickaxe = new SimplePickaxe(sterlingSteelPickaxeID, toolSterlingSteel).modId("sterlingandblack").setCreativeTab(SterlingAndBlackCore.tabAkkamaddiSterling).setUnlocalizedName("sterlingSteelPickaxe");
        sterlingSteelHoe = new SimpleHoe(sterlingSteelHoeID, toolSterlingSteel).modId("sterlingandblack").setCreativeTab(SterlingAndBlackCore.tabAkkamaddiSterling).setUnlocalizedName("sterlingSteelHoe");
        sterlingSteelHelm = new SimpleArmor(sterlingSteelHelmID, armorSterlingSteel, rendererSterlingSteel, 0).modId("sterlingandblack").setType("sterlingSteel").setCreativeTab(SterlingAndBlackCore.tabAkkamaddiSterling).setUnlocalizedName("sterlingSteelHelm");
        sterlingSteelChest = new SimpleArmor(sterlingSteelChestID, armorSterlingSteel, rendererSterlingSteel, 1).modId("sterlingandblack").setType("sterlingSteel").setCreativeTab(SterlingAndBlackCore.tabAkkamaddiSterling).setUnlocalizedName("sterlingSteelChest");
        sterlingSteelLegs = new SimpleArmor(sterlingSteelLegsID, armorSterlingSteel, rendererSterlingSteel, 2).modId("sterlingandblack").setType("sterlingSteel").setCreativeTab(SterlingAndBlackCore.tabAkkamaddiSterling).setUnlocalizedName("sterlingSteelLegs");
        sterlingSteelBoots = new SimpleArmor(sterlingSteelBootsID, armorSterlingSteel, rendererSterlingSteel, 3).modId("sterlingandblack").setType("sterlingSteel").setCreativeTab(SterlingAndBlackCore.tabAkkamaddiSterling).setUnlocalizedName("sterlingSteelBoots");
        blackSilverIngot = new SimpleIngot(blackSilverIngotID).modId("sterlingandblack").setCreativeTab(SterlingAndBlackCore.tabAkkamaddiSterling).setUnlocalizedName("blackSilverIngot");
        smallBlackSilverChunkItem = new SimpleIngot(smallBlackSilverChunkItemID).modId("sterlingandblack").setCreativeTab(SterlingAndBlackCore.tabAkkamaddiSterling).setUnlocalizedName("smallBlackSilverChunkItem");
        mediumBlackSilverChunkItem = new SimpleIngot(mediumBlackSilverChunkItemID).modId("sterlingandblack").setCreativeTab(SterlingAndBlackCore.tabAkkamaddiSterling).setUnlocalizedName("mediumBlackSilverChunkItem");
        largeBlackSilverChunkItem = new SimpleIngot(largeBlackSilverChunkItemID).modId("sterlingandblack").setCreativeTab(SterlingAndBlackCore.tabAkkamaddiSterling).setUnlocalizedName("largeBlackSilverChunkItem");
        blackSilverSword = new SimpleSword(blackSilverSwordID, toolBlackSilver).modId("sterlingandblack").setCreativeTab(SterlingAndBlackCore.tabAkkamaddiSterling).setUnlocalizedName("blackSilverSword");
        blackSilverShovel = new SimpleShovel(blackSilverShovelID, toolBlackSilver).modId("sterlingandblack").setCreativeTab(SterlingAndBlackCore.tabAkkamaddiSterling).setUnlocalizedName("blackSilverShovel");
        blackSilverAxe = new SimpleAxe(blackSilverAxeID, toolBlackSilver).modId("sterlingandblack").setCreativeTab(SterlingAndBlackCore.tabAkkamaddiSterling).setUnlocalizedName("blackSilverAxe");
        blackSilverPickaxe = new SimplePickaxe(blackSilverPickaxeID, toolBlackSilver).modId("sterlingandblack").setCreativeTab(SterlingAndBlackCore.tabAkkamaddiSterling).setUnlocalizedName("blackSilverPickaxe");
        blackSilverHoe = new SimpleHoe(blackSilverHoeID, toolBlackSilver).modId("sterlingandblack").setCreativeTab(SterlingAndBlackCore.tabAkkamaddiSterling).setUnlocalizedName("blackSilverHoe");
        blackSilverHelm = new SimpleArmor(blackSilverHelmID, armorBlackSilver, rendererBlackSilver, 0).modId("sterlingandblack").setType("blackSilver").setCreativeTab(SterlingAndBlackCore.tabAkkamaddiSterling).setUnlocalizedName("blackSilverHelm");
        blackSilverChest = new SimpleArmor(blackSilverChestID, armorBlackSilver, rendererBlackSilver, 1).modId("sterlingandblack").setType("blackSilver").setCreativeTab(SterlingAndBlackCore.tabAkkamaddiSterling).setUnlocalizedName("blackSilverChest");
        blackSilverLegs = new SimpleArmor(blackSilverLegsID, armorBlackSilver, rendererBlackSilver, 2).modId("sterlingandblack").setType("blackSilver").setCreativeTab(SterlingAndBlackCore.tabAkkamaddiSterling).setUnlocalizedName("blackSilverLegs");
        blackSilverBoots = new SimpleArmor(blackSilverBootsID, armorBlackSilver, rendererBlackSilver, 3).modId("sterlingandblack").setType("blackSilver").setCreativeTab(SterlingAndBlackCore.tabAkkamaddiSterling).setUnlocalizedName("blackSilverBoots");
        // define blocks
