...
public class ScintillaWheatBale extends BlockRotatedPillar
{
    public ScintillaWheatBale(int par1)
    {
    ...
    {
        this.field_111051_a = par1IconRegister.registerIcon("ashenwheat:scintillaWheatBale_top");
        this.blockIcon = par1IconRegister.registerIcon("ashenwheat:scintillaWheatBale_side");
    }
