...
@Mod(modid = "classicalalchemyores", name = "Classical Alchemy Ores", version = "0.0.0", dependencies = "required-after:simpleores ; required-after:classicalalchemy")
...
public class ClassicalAlchemyOresCore
{
    ...
    @SidedProxy(clientSide = "akkamaddi.classicalalchemyores.core.ClientProxy", serverSide = "akkamaddi.classicalalchemyores.core.CommonProxy")
