...
public class TungstenRecipes
{
    public static void doTungstenRecipes()
    {
        ...
        FusionRecipes.smelting().addSmelting(new ItemStack(SimpleTungstenCore.tungstenIngot), new ItemStack(Item.ingotIron), new ItemStack(Items.tinIngot), new ItemStack(SimpleTungstenCore.largeTungstenSteelChunkItem), 26.F);
        ...
        FusionRecipes.smelting().addSmelting(new ItemStack(SimpleTungstenCore.tungstenIngot), new ItemStack(Items.adamantiumIngot), new ItemStack(Item.glowstone), new ItemStack(SimpleTungstenCore.smallPrasinosChunkItem), 12.0F);
        FusionRecipes.smelting().addSmelting(new ItemStack(SimpleTungstenCore.tungstenIngot), new ItemStack(Items.adamantiumIngot), new ItemStack(Item.magmaCream), new ItemStack(SimpleTungstenCore.mediumPrasinosChunkItem), 16.0F);
        FusionRecipes.smelting().addSmelting(new ItemStack(SimpleTungstenCore.tungstenIngot), new ItemStack(Items.adamantiumIngot), new ItemStack(Item.blazePowder), new ItemStack(SimpleTungstenCore.largePrasinosChunkItem), 40.F);
