package SimpleOres.plugins.akkamaddi.goldenglitter.code;
...
public class GoldenGlitterCore
{
    ...
    @SidedProxy(clientSide = "SimpleOres.plugins.akkamaddi.goldenglitter.code.ClientProxy", serverSide = "SimpleOres.plugins.akkamaddi.goldenglitter.code.CommonProxy")
    ...
    public void preInit(FMLPreInitializationEvent event)
    {
        ...
        // define items
        // Rose Gold
        roseGoldIngot = new SimpleIngot(roseGoldIngotID, "goldenglitter", GoldenGlitterCore.tabAkkamaddiGolden).setUnlocalizedName("roseGoldIngot");
        largeRoseGoldChunkItem = new SimpleIngot(largeRoseGoldChunkItemID, "goldenglitter", GoldenGlitterCore.tabAkkamaddiGolden).setUnlocalizedName("largeRoseGoldChunkItem");
        roseGoldSword = new SimpleSword(roseGoldSwordID, toolRoseGold, "goldenglitter", GoldenGlitterCore.tabAkkamaddiGolden).setUnlocalizedName("roseGoldSword");
        roseGoldShovel = new SimpleShovel(roseGoldShovelID, toolRoseGold, "goldenglitter", GoldenGlitterCore.tabAkkamaddiGolden).setUnlocalizedName("roseGoldShovel");
        roseGoldAxe = new SimpleAxe(roseGoldAxeID, toolRoseGold, "goldenglitter", GoldenGlitterCore.tabAkkamaddiGolden).setUnlocalizedName("roseGoldAxe");
        roseGoldPickaxe = new SimplePickaxe(roseGoldPickaxeID, toolRoseGold, "goldenglitter", GoldenGlitterCore.tabAkkamaddiGolden).setUnlocalizedName("roseGoldPickaxe");
        roseGoldHoe = new SimpleHoe(roseGoldHoeID, toolRoseGold, "goldenglitter", GoldenGlitterCore.tabAkkamaddiGolden).setUnlocalizedName("roseGoldHoe");
        roseGoldHelm = new SimpleArmor(roseGoldHelmID, armorRoseGold, rendererRoseGold, 0, "roseGold", "goldenglitter", GoldenGlitterCore.tabAkkamaddiGolden).setUnlocalizedName("roseGoldHelm");
        roseGoldChest = new SimpleArmor(roseGoldChestID, armorRoseGold, rendererRoseGold, 1, "roseGold", "goldenglitter", GoldenGlitterCore.tabAkkamaddiGolden).setUnlocalizedName("roseGoldChest");
        roseGoldLegs = new SimpleArmor(roseGoldLegsID, armorRoseGold, rendererRoseGold, 2, "roseGold", "goldenglitter", GoldenGlitterCore.tabAkkamaddiGolden).setUnlocalizedName("roseGoldLegs");
        roseGoldBoots = new SimpleArmor(roseGoldBootsID, armorRoseGold, rendererRoseGold, 3, "roseGold", "goldenglitter", GoldenGlitterCore.tabAkkamaddiGolden).setUnlocalizedName("roseGoldBoots");
        //Erubescent Gold
        erubescentGoldIngot = new SimpleIngot(erubescentGoldIngotID, "goldenglitter", GoldenGlitterCore.tabAkkamaddiGolden).setUnlocalizedName("erubescentGoldIngot");
        largeErubescentGoldChunkItem = new SimpleIngot(largeErubescentGoldChunkItemID, "goldenglitter", GoldenGlitterCore.tabAkkamaddiGolden).setUnlocalizedName("largeErubescentGoldChunkItem");
        erubescentGoldSword = new SimpleSword(erubescentGoldSwordID, toolErubescentGold, "goldenglitter", GoldenGlitterCore.tabAkkamaddiGolden).setUnlocalizedName("erubescentGoldSword");
        erubescentGoldShovel = new SimpleShovel(erubescentGoldShovelID, toolErubescentGold, "goldenglitter", GoldenGlitterCore.tabAkkamaddiGolden).setUnlocalizedName("erubescentGoldShovel");
        erubescentGoldAxe = new SimpleAxe(erubescentGoldAxeID, toolErubescentGold, "goldenglitter", GoldenGlitterCore.tabAkkamaddiGolden).setUnlocalizedName("erubescentGoldAxe");
        erubescentGoldPickaxe = new SimplePickaxe(erubescentGoldPickaxeID, toolErubescentGold, "goldenglitter", GoldenGlitterCore.tabAkkamaddiGolden).setUnlocalizedName("erubescentGoldPickaxe");
        //Scarlatite Gold
        scarlatiteGoldIngot = new SimpleIngot(scarlatiteGoldIngotID, "goldenglitter", GoldenGlitterCore.tabAkkamaddiGolden).setUnlocalizedName("scarlatiteGoldIngot");
        largeScarlatiteGoldChunkItem = new SimpleIngot(largeScarlatiteGoldChunkItemID, "goldenglitter", GoldenGlitterCore.tabAkkamaddiGolden).setUnlocalizedName("largeScarlatiteGoldChunkItem");
        scarlatiteGoldSword = new SimpleSword(scarlatiteGoldSwordID, toolScarlatiteGold, "goldenglitter", GoldenGlitterCore.tabAkkamaddiGolden).setUnlocalizedName("scarlatiteGoldSword");
        scarlatiteGoldShovel = new SimpleShovel(scarlatiteGoldShovelID, toolScarlatiteGold, "goldenglitter", GoldenGlitterCore.tabAkkamaddiGolden).setUnlocalizedName("scarlatiteGoldShovel");
        scarlatiteGoldAxe = new SimpleAxe(scarlatiteGoldAxeID, toolScarlatiteGold, "goldenglitter", GoldenGlitterCore.tabAkkamaddiGolden).setUnlocalizedName("scarlatiteGoldAxe");
        scarlatiteGoldPickaxe = new SimplePickaxe(scarlatiteGoldPickaxeID, toolScarlatiteGold, "goldenglitter", GoldenGlitterCore.tabAkkamaddiGolden).setUnlocalizedName("scarlatiteGoldPickaxe");
        //Hephaestan Gold
        hephaestanGoldIngot = new SimpleIngot(hephaestanGoldIngotID, "goldenglitter", GoldenGlitterCore.tabAkkamaddiGolden).setUnlocalizedName("hephaestanGoldIngot");
        largeHephaestanGoldChunkItem = new SimpleIngot(largeHephaestanGoldChunkItemID, "goldenglitter", GoldenGlitterCore.tabAkkamaddiGolden).setUnlocalizedName("largeHephaestanGoldChunkItem");
        hephaestanGoldSword = new HephaestanSword(hephaestanGoldSwordID, toolHephaestanGold, "goldenglitter", GoldenGlitterCore.tabAkkamaddiGolden).setUnlocalizedName("hephaestanGoldSword");
        hephaestanGoldShovel = new SimpleShovel(hephaestanGoldShovelID, toolHephaestanGold, "goldenglitter", GoldenGlitterCore.tabAkkamaddiGolden).setUnlocalizedName("hephaestanGoldShovel");
        hephaestanGoldAxe = new SimpleAxe(hephaestanGoldAxeID, toolHephaestanGold, "goldenglitter", GoldenGlitterCore.tabAkkamaddiGolden).setUnlocalizedName("hephaestanGoldAxe");
        hephaestanGoldPickaxe = new SimplePickaxe(hephaestanGoldPickaxeID, toolHephaestanGold, "goldenglitter", GoldenGlitterCore.tabAkkamaddiGolden).setUnlocalizedName("hephaestanGoldPickaxe");
        // define blocks
        ...
        // loot
        HandlerLoot.lootHandler().addLoot("villageBlacksmith", roseGoldIngot, 2, 4, 4);
        HandlerLoot.lootHandler().addLoot("villageBlacksmith", largeRoseGoldChunkItem, 1, 2, 3);
        HandlerLoot.lootHandler().addLoot("villageBlacksmith", roseGoldSword, 2, 4, 1);
        HandlerLoot.lootHandler().addLoot("villageBlacksmith", roseGoldPickaxe, 2, 4, 1);
        HandlerLoot.lootHandler().addLoot("villageBlacksmith", roseGoldAxe, 1, 2, 1);
        HandlerLoot.lootHandler().addLoot("villageBlacksmith", roseGoldShovel, 1, 2, 1);
        HandlerLoot.lootHandler().addLoot("villageBlacksmith", roseGoldHelm, 1, 4, 1);
        HandlerLoot.lootHandler().addLoot("villageBlacksmith", roseGoldChest, 1, 4, 1);
        HandlerLoot.lootHandler().addLoot("villageBlacksmith", roseGoldLegs, 1, 4, 1);
        HandlerLoot.lootHandler().addLoot("villageBlacksmith", roseGoldBoots, 1, 4, 1);
        HandlerLoot.lootHandler().addLoot("villageBlacksmith", erubescentGoldPickaxe, 1, 3, 1);
        HandlerLoot.lootHandler().addLoot("villageBlacksmith", scarlatiteGoldPickaxe, 1, 2, 1);
        HandlerLoot.lootHandler().addLoot("villageBlacksmith", hephaestanGoldPickaxe, 1, 1, 1);
        HandlerLoot.lootHandler().addLoot("dungeonChest", roseGoldIngot, 2, 4, 6);
        HandlerLoot.lootHandler().addLoot("dungeonChest", roseGoldPickaxe, 2, 6, 1);
        HandlerLoot.lootHandler().addLoot("dungeonChest", erubescentGoldIngot, 1, 2, 2);
        HandlerLoot.lootHandler().addLoot("dungeonChest", scarlatiteGoldIngot, 1, 1, 1);
        HandlerLoot.lootHandler().addLoot("dungeonChest", erubescentGoldSword, 1, 3, 1);
        HandlerLoot.lootHandler().addLoot("dungeonChest", scarlatiteGoldSword, 1, 2, 1);
        HandlerLoot.lootHandler().addLoot("dungeonChest", hephaestanGoldSword, 1, 1, 1);
        HandlerLoot.lootHandler().addLoot("mineshaftCorridor", roseGoldSword, 1, 3, 1);
        HandlerLoot.lootHandler().addLoot("mineshaftCorridor", roseGoldPickaxe, 2, 4, 1);
        HandlerLoot.lootHandler().addLoot("mineshaftCorridor", roseGoldShovel, 1, 2, 1);
        HandlerLoot.lootHandler().addLoot("mineshaftCorridor", erubescentGoldPickaxe, 1, 3, 1);
        HandlerLoot.lootHandler().addLoot("mineshaftCorridor", scarlatiteGoldPickaxe, 1, 2, 1);
        HandlerLoot.lootHandler().addLoot("mineshaftCorridor", hephaestanGoldPickaxe, 1, 1, 1);
        HandlerLoot.lootHandler().addLoot("mineshaftCorridor", erubescentGoldShovel, 1, 3, 1);
        HandlerLoot.lootHandler().addLoot("mineshaftCorridor", scarlatiteGoldShovel, 1, 2, 1);
        HandlerLoot.lootHandler().addLoot("mineshaftCorridor", hephaestanGoldShovel, 1, 1, 1);
        HandlerLoot.lootHandler().addLoot("pyramidDesertyChest", erubescentGoldIngot, 1, 4, 4);
        HandlerLoot.lootHandler().addLoot("pyramidDesertyChest", scarlatiteGoldIngot, 1, 3, 3);
        HandlerLoot.lootHandler().addLoot("pyramidDesertyChest", hephaestanGoldIngot, 1, 2, 2);
        HandlerLoot.lootHandler().addLoot("pyramidDesertyChest", erubescentGoldSword, 1, 1, 1);
        HandlerLoot.lootHandler().addLoot("pyramidDesertyChest", scarlatiteGoldSword, 1, 2, 1);
        HandlerLoot.lootHandler().addLoot("pyramidDesertyChest", hephaestanGoldSword, 1, 3, 1);
        HandlerLoot.lootHandler().addLoot("pyramidJungleChest", erubescentGoldIngot, 1, 4, 4);
        HandlerLoot.lootHandler().addLoot("pyramidJungleChest", scarlatiteGoldIngot, 1, 3, 3);
        HandlerLoot.lootHandler().addLoot("pyramidJungleChest", hephaestanGoldIngot, 1, 2, 2);
        HandlerLoot.lootHandler().addLoot("pyramidJungleChest", erubescentGoldSword, 1, 1, 1);
        HandlerLoot.lootHandler().addLoot("pyramidJungleChest", scarlatiteGoldSword, 1, 2, 1);
        HandlerLoot.lootHandler().addLoot("pyramidJungleChest", hephaestanGoldSword, 1, 3, 1);
