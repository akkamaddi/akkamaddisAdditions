...
public class GlitterRecipes
{
    public static void doGlitterRecipes()
    {
        ...
        if (GoldenGlitterCore.enableRecycling) {
        	// rose gold
            FusionRecipes.smelting().addSmelting(new ItemStack(GoldenGlitterCore.roseGoldHelm, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(GoldenGlitterCore.largeRoseGoldChunkItem), 10.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(GoldenGlitterCore.roseGoldChest, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel, 2, 0), new ItemStack(Item.coal, 2, OreDictionary.WILDCARD_VALUE), new ItemStack(GoldenGlitterCore.largeRoseGoldChunkItem, 2, 0), 20.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(GoldenGlitterCore.roseGoldLegs, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel, 2, 0), new ItemStack(Item.coal, 2, OreDictionary.WILDCARD_VALUE), new ItemStack(GoldenGlitterCore.largeRoseGoldChunkItem, 2, 0), 20.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(GoldenGlitterCore.roseGoldBoots, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(GoldenGlitterCore.largeRoseGoldChunkItem), 10.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(GoldenGlitterCore.roseGoldSword, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(GoldenGlitterCore.largeRoseGoldChunkItem), 10.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(GoldenGlitterCore.roseGoldShovel, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(GoldenGlitterCore.largeRoseGoldChunkItem), 10.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(GoldenGlitterCore.roseGoldPickaxe, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(GoldenGlitterCore.largeRoseGoldChunkItem), 10.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(GoldenGlitterCore.roseGoldAxe, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(GoldenGlitterCore.largeRoseGoldChunkItem), 10.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(GoldenGlitterCore.roseGoldHoe, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(GoldenGlitterCore.largeRoseGoldChunkItem), 10.0F);
            //erubescent gold
            FusionRecipes.smelting().addSmelting(new ItemStack(GoldenGlitterCore.erubescentGoldSword, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(GoldenGlitterCore.largeErubescentGoldChunkItem), 15.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(GoldenGlitterCore.erubescentGoldShovel, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(GoldenGlitterCore.largeErubescentGoldChunkItem), 15.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(GoldenGlitterCore.erubescentGoldAxe, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(GoldenGlitterCore.largeErubescentGoldChunkItem), 15.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(GoldenGlitterCore.erubescentGoldPickaxe, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(GoldenGlitterCore.largeErubescentGoldChunkItem), 15.0F);
            //scarlatite gold
            FusionRecipes.smelting().addSmelting(new ItemStack(GoldenGlitterCore.scarlatiteGoldSword, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(GoldenGlitterCore.largeScarlatiteGoldChunkItem), 20.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(GoldenGlitterCore.scarlatiteGoldShovel, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(GoldenGlitterCore.largeScarlatiteGoldChunkItem), 20.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(GoldenGlitterCore.scarlatiteGoldAxe, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(GoldenGlitterCore.largeScarlatiteGoldChunkItem), 20.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(GoldenGlitterCore.scarlatiteGoldPickaxe, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(GoldenGlitterCore.largeScarlatiteGoldChunkItem), 20.0F);
            //hephaestan gold
            FusionRecipes.smelting().addSmelting(new ItemStack(GoldenGlitterCore.hephaestanGoldSword, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.bucketLava), new ItemStack(GoldenGlitterCore.largeHephaestanGoldChunkItem), 25.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(GoldenGlitterCore.hephaestanGoldShovel, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.bucketLava), new ItemStack(GoldenGlitterCore.largeHephaestanGoldChunkItem), 25.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(GoldenGlitterCore.hephaestanGoldAxe, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.bucketLava), new ItemStack(GoldenGlitterCore.largeHephaestanGoldChunkItem), 25.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(GoldenGlitterCore.hephaestanGoldPickaxe, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.bucketLava), new ItemStack(GoldenGlitterCore.largeHephaestanGoldChunkItem), 25.0F);
