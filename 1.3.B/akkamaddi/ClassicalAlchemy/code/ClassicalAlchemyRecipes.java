...
public class ClassicalAlchemyRecipes
{
    ...
    public static void doCARecipes()
    {
        ...
        if (ClassicalAlchemyCore.enableRecycling) {
            ...
            FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ClassicalAlchemyCore.stannumBoots, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(ClassicalAlchemyCore.largeStannumChunkItem), 7.0F);
            FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ClassicalAlchemyCore.stannumSword, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(ClassicalAlchemyCore.largeStannumChunkItem), 7.0F);
            FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ClassicalAlchemyCore.stannumShovel, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(ClassicalAlchemyCore.largeStannumChunkItem), 7.0F);
            FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ClassicalAlchemyCore.stannumPickaxe, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(ClassicalAlchemyCore.largeStannumChunkItem), 7.0F);
            FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ClassicalAlchemyCore.stannumAxe, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(ClassicalAlchemyCore.largeStannumChunkItem), 7.0F);
            FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ClassicalAlchemyCore.stannumHoe, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(ClassicalAlchemyCore.largeStannumChunkItem), 7.0F);
            // Cuprum
            FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ClassicalAlchemyCore.cuprumHelm, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(ClassicalAlchemyCore.largeCuprumChunkItem), 7.0F);
            FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ClassicalAlchemyCore.cuprumChest, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel, 2, 0), new ItemStack(Item.coal, 2, OreDictionary.WILDCARD_VALUE), new ItemStack(ClassicalAlchemyCore.largeCuprumChunkItem, 2, 0), 14.0F);
            FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ClassicalAlchemyCore.cuprumLegs, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel, 2, 0), new ItemStack(Item.coal, 2, OreDictionary.WILDCARD_VALUE), new ItemStack(ClassicalAlchemyCore.largeCuprumChunkItem, 2, 0), 14.0F);
            FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ClassicalAlchemyCore.cuprumBoots, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(ClassicalAlchemyCore.largeCuprumChunkItem), 7.0F);
            FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ClassicalAlchemyCore.cuprumSword, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(ClassicalAlchemyCore.largeCuprumChunkItem), 7.0F);
            FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ClassicalAlchemyCore.cuprumShovel, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(ClassicalAlchemyCore.largeCuprumChunkItem), 7.0F);
            FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ClassicalAlchemyCore.cuprumPickaxe, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(ClassicalAlchemyCore.largeCuprumChunkItem), 7.0F);
            FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ClassicalAlchemyCore.cuprumAxe, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(ClassicalAlchemyCore.largeCuprumChunkItem), 7.0F);
            FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ClassicalAlchemyCore.cuprumHoe, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(ClassicalAlchemyCore.largeCuprumChunkItem), 7.0F);
            // Pyropus Bronze
            FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ClassicalAlchemyCore.pyropusBronzeHelm, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(ClassicalAlchemyCore.largePyropusBronzeChunkItem), 10.0F);
            FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ClassicalAlchemyCore.pyropusBronzeChest, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel, 2, 0), new ItemStack(Item.coal, 2, OreDictionary.WILDCARD_VALUE), new ItemStack(ClassicalAlchemyCore.largePyropusBronzeChunkItem, 2, 0), 20.0F);
            FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ClassicalAlchemyCore.pyropusBronzeLegs, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel, 2, 0), new ItemStack(Item.coal, 2, OreDictionary.WILDCARD_VALUE), new ItemStack(ClassicalAlchemyCore.largePyropusBronzeChunkItem, 2, 0), 20.0F);
            FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ClassicalAlchemyCore.pyropusBronzeBoots, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(ClassicalAlchemyCore.largePyropusBronzeChunkItem), 10.0F);
            FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ClassicalAlchemyCore.pyropusBronzeSword, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(ClassicalAlchemyCore.largePyropusBronzeChunkItem), 10.0F);
            FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ClassicalAlchemyCore.pyropusBronzeShovel, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(ClassicalAlchemyCore.largePyropusBronzeChunkItem), 10.0F);
            FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ClassicalAlchemyCore.pyropusBronzePickaxe, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(ClassicalAlchemyCore.largePyropusBronzeChunkItem), 10.0F);
            FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ClassicalAlchemyCore.pyropusBronzeAxe, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(ClassicalAlchemyCore.largePyropusBronzeChunkItem), 10.0F);
            FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ClassicalAlchemyCore.pyropusBronzeHoe, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(ClassicalAlchemyCore.largePyropusBronzeChunkItem), 10.0F);
            // Pulchrum Bronze
            FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ClassicalAlchemyCore.pulchrumBronzeSword, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(ClassicalAlchemyCore.largePulchrumBronzeChunkItem), 15.0F);
            FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ClassicalAlchemyCore.pulchrumBronzeShovel, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(ClassicalAlchemyCore.largePulchrumBronzeChunkItem), 15.0F);
            FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ClassicalAlchemyCore.pulchrumBronzePickaxe, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(ClassicalAlchemyCore.largePulchrumBronzeChunkItem), 15.0F);
            FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ClassicalAlchemyCore.pulchrumBronzeAxe, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(ClassicalAlchemyCore.largePulchrumBronzeChunkItem), 15.0F);
            // Tomb Bronze
            FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ClassicalAlchemyCore.tombBronzeHelm, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.rottenFlesh), new ItemStack(ClassicalAlchemyCore.largeTombBronzeChunkItem), 15.0F);
            FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ClassicalAlchemyCore.tombBronzeChest, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel, 2, 0), new ItemStack(Item.rottenFlesh), new ItemStack(ClassicalAlchemyCore.largeTombBronzeChunkItem, 2, 0), 30.0F);
            FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ClassicalAlchemyCore.tombBronzeLegs, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel, 2, 0), new ItemStack(Item.rottenFlesh), new ItemStack(ClassicalAlchemyCore.largeTombBronzeChunkItem, 2, 0), 30.0F);
            FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ClassicalAlchemyCore.tombBronzeBoots, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.rottenFlesh), new ItemStack(ClassicalAlchemyCore.largeTombBronzeChunkItem), 15.0F);
            FusionHelper.fusionFurnaceRecipes.smelting().addSmelting(new ItemStack(ClassicalAlchemyCore.tombBronzeSword, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.rottenFlesh), new ItemStack(ClassicalAlchemyCore.largeTombBronzeChunkItem), 15.0F);
