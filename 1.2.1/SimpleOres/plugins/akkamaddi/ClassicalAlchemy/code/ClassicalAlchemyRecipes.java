...
import SimpleOres.plugins.akkamaddi.ClassicalAlchemy.code.SimpleArsenicContents;
...
public class ClassicalAlchemyRecipes
{
    ...
    public static void doStannumRecipes()
    {
        ...
        /*
    	//PulchrumBronze chunks
		GameRegistry.addShapelessRecipe(new ItemStack(ClassicalAlchemyCore.largePulchrumBronzeChunkItem, 1), new Object[]
                { ClassicalAlchemyCore.largePyropusBronzeChunkItem, Item.goldNugget, Item.goldNugget, Item.goldNugget });
        */
        ...
        FusionRecipes.smelting().addSmelting(new ItemStack(Items.tinIngot), new ItemStack(Items.tinIngot), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(ClassicalAlchemyCore.smallStannumChunkItem), 1.0F);
        FusionRecipes.smelting().addSmelting(new ItemStack(Items.tinIngot), new ItemStack(Items.tinIngot), new ItemStack(Item.dyePowder, 1, 15), new ItemStack(ClassicalAlchemyCore.mediumStannumChunkItem), 2.0F);
        FusionRecipes.smelting().addSmelting(new ItemStack(Items.tinIngot), new ItemStack(Items.tinIngot), new ItemStack(Item.gunpowder), new ItemStack(ClassicalAlchemyCore.largeStannumChunkItem), 5.0F);

        FusionRecipes.smelting().addSmelting(new ItemStack(Items.copperIngot), new ItemStack(Items.copperIngot), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(ClassicalAlchemyCore.smallCuprumChunkItem), 1.0F);
        FusionRecipes.smelting().addSmelting(new ItemStack(Items.copperIngot), new ItemStack(Items.copperIngot), new ItemStack(Item.dyePowder, 1, 15), new ItemStack(ClassicalAlchemyCore.mediumCuprumChunkItem), 2.0F);
        FusionRecipes.smelting().addSmelting(new ItemStack(Items.copperIngot), new ItemStack(Items.copperIngot), new ItemStack(Item.gunpowder), new ItemStack(ClassicalAlchemyCore.largeCuprumChunkItem), 5.0F);
