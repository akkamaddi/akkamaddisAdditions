...
public class CobaltRecipes
{
    public static void doCobaltRecipes()
    {
        ...
        // Blue Drift Steel
        FusionRecipes.smelting().addSmelting(new ItemStack(SimpleCobaltCore.cobaltIngot), new ItemStack(Item.ingotIron), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(SimpleCobaltCore.smallBlueDriftSteelChunkItem), 6.0F);
        FusionRecipes.smelting().addSmelting(new ItemStack(SimpleCobaltCore.cobaltIngot), new ItemStack(Item.ingotIron), new ItemStack(Item.gunpowder), new ItemStack(SimpleCobaltCore.mediumBlueDriftSteelChunkItem), 8.0F);
        ...
        if (SimpleCobaltCore.enableRecycling) {
            ...
            // Blue Drift Steel
            FusionRecipes.smelting().addSmelting(new ItemStack(SimpleCobaltCore.blueDriftSteelHelm, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(SimpleCobaltCore.largeBlueDriftSteelChunkItem), 15.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(SimpleCobaltCore.blueDriftSteelChest, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel, 2, 0), new ItemStack(Item.coal, 2, OreDictionary.WILDCARD_VALUE), new ItemStack(SimpleCobaltCore.largeBlueDriftSteelChunkItem, 2, 0), 30.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(SimpleCobaltCore.blueDriftSteelLegs, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel, 2, 0), new ItemStack(Item.coal, 2, OreDictionary.WILDCARD_VALUE), new ItemStack(SimpleCobaltCore.largeBlueDriftSteelChunkItem, 2, 0), 30.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(SimpleCobaltCore.blueDriftSteelBoots, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(SimpleCobaltCore.largeBlueDriftSteelChunkItem), 15.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(SimpleCobaltCore.blueDriftSteelSword, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(SimpleCobaltCore.largeBlueDriftSteelChunkItem), 15.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(SimpleCobaltCore.blueDriftSteelShovel, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(SimpleCobaltCore.largeBlueDriftSteelChunkItem), 15.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(SimpleCobaltCore.blueDriftSteelPickaxe, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(SimpleCobaltCore.largeBlueDriftSteelChunkItem), 15.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(SimpleCobaltCore.blueDriftSteelAxe, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(SimpleCobaltCore.largeBlueDriftSteelChunkItem), 15.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(SimpleCobaltCore.blueDriftSteelHoe, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Block.gravel), new ItemStack(Item.coal, 1, OreDictionary.WILDCARD_VALUE), new ItemStack(SimpleCobaltCore.largeBlueDriftSteelChunkItem), 15.0F);
