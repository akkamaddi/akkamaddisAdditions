package SimpleOres.plugins.akkamaddi.simplecobalt;
...
public class SimpleCobaltCore
{
    ...
    @SidedProxy(clientSide = "SimpleOres.plugins.akkamaddi.simplecobalt.ClientProxy", serverSide = "SimpleOres.plugins.akkamaddi.simplecobalt.CommonProxy")
    ...
    public void preInit(FMLPreInitializationEvent event)
    {
        ...
        // define items
        // Cobalt
        cobaltIngot = new SimpleIngot(cobaltIngotID, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("cobaltIngot");

        cobaltSword = new SimpleSword(cobaltSwordID, toolCobalt, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("cobaltSword");

        cobaltShovel = new SimpleShovel(cobaltShovelID, toolCobalt, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("cobaltShovel");

        cobaltAxe = new SimpleAxe(cobaltAxeID, toolCobalt, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("cobaltAxe");

        cobaltPickaxe = new SimplePickaxe(cobaltPickaxeID, toolCobalt, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("cobaltPickaxe");

        cobaltHoe = new SimpleHoe(cobaltHoeID, toolCobalt, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("cobaltHoe");

        cobaltHelm = new SimpleArmor(cobaltHelmID, armorCobalt, rendererCobalt, 0, "cobalt", "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("cobaltHelm");

        cobaltChest = new SimpleArmor(cobaltChestID, armorCobalt, rendererCobalt, 1, "cobalt", "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("cobaltChest");

        cobaltLegs = new SimpleArmor(cobaltLegsID, armorCobalt, rendererCobalt, 2, "cobalt", "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("cobaltLegs");

        cobaltBoots = new SimpleArmor(cobaltBootsID, armorCobalt, rendererCobalt, 3, "cobalt", "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("cobaltBoots");

        // Blue Drift Steel
        blueDriftSteelIngot = new SimpleIngot(blueDriftSteelIngotID, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("blueDriftSteelIngot");

        smallBlueDriftSteelChunkItem = new SimpleIngot(smallBlueDriftSteelChunkItemID, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("smallBlueDriftSteelChunkItem");

        mediumBlueDriftSteelChunkItem = new SimpleIngot(mediumBlueDriftSteelChunkItemID, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("mediumBlueDriftSteelChunkItem");

        largeBlueDriftSteelChunkItem = new SimpleIngot(largeBlueDriftSteelChunkItemID, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("largeBlueDriftSteelChunkItem");

        blueDriftSteelSword = new SimpleSword(blueDriftSteelSwordID, toolBlueDriftSteel, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("blueDriftSteelSword");

        blueDriftSteelShovel = new SimpleShovel(blueDriftSteelShovelID, toolBlueDriftSteel, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("blueDriftSteelShovel");

        blueDriftSteelAxe = new SimpleAxe(blueDriftSteelAxeID, toolBlueDriftSteel, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("blueDriftSteelAxe");

        blueDriftSteelPickaxe = new SimplePickaxe(blueDriftSteelPickaxeID, toolBlueDriftSteel, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("blueDriftSteelPickaxe");

        blueDriftSteelHoe = new SimpleHoe(blueDriftSteelHoeID, toolBlueDriftSteel, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("blueDriftSteelHoe");

        blueDriftSteelHelm = new SimpleArmor(blueDriftSteelHelmID, armorBlueDriftSteel, rendererBlueDriftSteel, 0, "bluedriftsteel", "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("blueDriftSteelHelm");

        blueDriftSteelChest = new SimpleArmor(blueDriftSteelChestID, armorBlueDriftSteel, rendererBlueDriftSteel, 1, "bluedriftsteel", "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("blueDriftSteelChest");

        blueDriftSteelLegs = new SimpleArmor(blueDriftSteelLegsID, armorBlueDriftSteel, rendererBlueDriftSteel, 2, "bluedriftsteel", "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("blueDriftSteelLegs");

        blueDriftSteelBoots = new SimpleArmor(blueDriftSteelBootsID, armorBlueDriftSteel, rendererBlueDriftSteel, 3, "bluedriftsteel", "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("blueDriftSteelBoots");

        // Blue Celadon
        blueCeladonIngot = new SimpleIngot(blueCeladonIngotID, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("blueCeladonIngot");

        smallBlueCeladonChunkItem = new SimpleIngot(smallBlueCeladonChunkItemID, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("smallBlueCeladonChunkItem");

        mediumBlueCeladonChunkItem = new SimpleIngot(mediumBlueCeladonChunkItemID, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("mediumBlueCeladonChunkItem");

        largeBlueCeladonChunkItem = new SimpleIngot(largeBlueCeladonChunkItemID, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("largeBlueCeladonChunkItem");

        blueCeladonSword = new SimpleSword(blueCeladonSwordID, toolBlueCeladon, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("blueCeladonSword");

        blueCeladonShovel = new SimpleShovel(blueCeladonShovelID, toolBlueCeladon, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("blueCeladonShovel");

        blueCeladonAxe = new SimpleAxe(blueCeladonAxeID, toolBlueCeladon, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("blueCeladonAxe");

        blueCeladonPickaxe = new SimplePickaxe(blueCeladonPickaxeID, toolBlueCeladon, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("blueCeladonPickaxe");
        ...
        smallGreenCeladonChunkItem = new SimpleIngot(smallGreenCeladonChunkItemID, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("smallGreenCeladonChunkItem");

        mediumGreenCeladonChunkItem = new SimpleIngot(mediumGreenCeladonChunkItemID, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("mediumGreenCeladonChunkItem");

        largeGreenCeladonChunkItem = new SimpleIngot(largeGreenCeladonChunkItemID, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("largeGreenCeladonChunkItem");

        greenCeladonSword = new SimpleSword(greenCeladonSwordID, toolGreenCeladon, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("greenCeladonSword");

        greenCeladonShovel = new SimpleShovel(greenCeladonShovelID, toolGreenCeladon, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("greenCeladonShovel");

        greenCeladonAxe = new SimpleAxe(greenCeladonAxeID, toolGreenCeladon, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("greenCeladonAxe");

        greenCeladonPickaxe = new SimplePickaxe(greenCeladonPickaxeID, toolGreenCeladon, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt).setUnlocalizedName("greenCeladonPickaxe");
        ...
        oreCobalt = new SimpleOre(oreCobaltID, Material.iron, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt)
        .setHardness(4.0F).setResistance(10.0F).setStepSound(Block.soundMetalFootstep)
        .setUnlocalizedName("oreCobalt");

        blockBlueDriftSteel = new SimpleOre(blockBlueDriftSteelID, Material.iron, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt)
        .setHardness(10.0F).setResistance(22.0F).setStepSound(Block.soundMetalFootstep)
        .setUnlocalizedName("blockBlueDriftSteel").setLightValue(1.0F);

        blockBlueCeladon = new SimpleOre(blockBlueCeladonID, Material.iron, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt)
        .setHardness(10.0F).setResistance(22.0F).setStepSound(Block.soundMetalFootstep)
        .setUnlocalizedName("blockBlueCeladon");

        blockGreenCeladon = new SimpleOre(blockGreenCeladonID, Material.iron, "simplecobalt", SimpleCobaltCore.tabAkkamaddiCobalt)
        .setHardness(10.0F).setResistance(22.0F).setStepSound(Block.soundMetalFootstep)
        ...
        // loot
        HandlerLoot.lootHandler().addLoot("villageBlacksmith", cobaltIngot, 2, 4, 6);
        HandlerLoot.lootHandler().addLoot("villageBlacksmith", cobaltSword, 2, 3, 1);
        HandlerLoot.lootHandler().addLoot("villageBlacksmith", cobaltPickaxe, 2, 3, 1);
        HandlerLoot.lootHandler().addLoot("villageBlacksmith", cobaltAxe, 2, 3, 1);
        HandlerLoot.lootHandler().addLoot("villageBlacksmith", cobaltShovel, 2, 3, 1);
        HandlerLoot.lootHandler().addLoot("villageBlacksmith", blueDriftSteelIngot, 2, 3, 4);
        HandlerLoot.lootHandler().addLoot("villageBlacksmith", blueCeladonIngot, 2, 3, 3);
        HandlerLoot.lootHandler().addLoot("villageBlacksmith", greenCeladonIngot, 1, 2, 2);
        HandlerLoot.lootHandler().addLoot("villageBlacksmith", blueDriftSteelSword, 1, 2, 1);
        HandlerLoot.lootHandler().addLoot("villageBlacksmith", blueCeladonSword, 1, 2, 1);
        HandlerLoot.lootHandler().addLoot("villageBlacksmith", greenCeladonSword, 1, 1, 1);

        HandlerLoot.lootHandler().addLoot("dungeonChest", blueDriftSteelSword, 1, 2, 1);
        HandlerLoot.lootHandler().addLoot("dungeonChest", blueDriftSteelPickaxe, 1, 2, 1);
        HandlerLoot.lootHandler().addLoot("dungeonChest", blueCeladonPickaxe, 1, 2, 1);
        HandlerLoot.lootHandler().addLoot("dungeonChest", greenCeladonPickaxe, 1, 1, 1);
        HandlerLoot.lootHandler().addLoot("dungeonChest", blueCeladonSword, 1, 2, 1);
        HandlerLoot.lootHandler().addLoot("dungeonChest", greenCeladonSword, 1, 1, 1);
        

        HandlerLoot.lootHandler().addLoot("mineshaftCorridor", cobaltIngot, 2, 3, 3);
        HandlerLoot.lootHandler().addLoot("mineshaftCorridor", cobaltSword, 1, 2, 1);
        HandlerLoot.lootHandler().addLoot("mineshaftCorridor", cobaltPickaxe, 2, 3, 2);
        HandlerLoot.lootHandler().addLoot("mineshaftCorridor", cobaltShovel, 2, 3, 2);
        HandlerLoot.lootHandler().addLoot("mineshaftCorridor", blueDriftSteelPickaxe, 2, 3, 1);
        HandlerLoot.lootHandler().addLoot("mineshaftCorridor", blueDriftSteelShovel, 1, 1, 1);
        HandlerLoot.lootHandler().addLoot("mineshaftCorridor", blueCeladonPickaxe, 1, 1, 1);
        HandlerLoot.lootHandler().addLoot("mineshaftCorridor", blueCeladonShovel, 1, 1, 1);
        HandlerLoot.lootHandler().addLoot("mineshaftCorridor", greenCeladonPickaxe, 1, 1, 1);
        HandlerLoot.lootHandler().addLoot("mineshaftCorridor", greenCeladonShovel, 1, 1, 1);
        
        HandlerLoot.lootHandler().addLoot("pyramidDesertyChest", blueDriftSteelIngot, 1, 2, 3);
        HandlerLoot.lootHandler().addLoot("pyramidDesertyChest", blueCeladonIngot, 1, 1, 1);
        HandlerLoot.lootHandler().addLoot("pyramidDesertyChest", greenCeladonIngot, 1, 1, 1);
        HandlerLoot.lootHandler().addLoot("pyramidDesertyChest", blueDriftSteelSword, 2, 4, 1);
        HandlerLoot.lootHandler().addLoot("pyramidDesertyChest", blueCeladonSword, 1, 1, 1);
        HandlerLoot.lootHandler().addLoot("pyramidDesertyChest", greenCeladonSword, 1, 1, 1);
        HandlerLoot.lootHandler().addLoot("pyramidDesertyChest", cobaltSword, 1, 5, 1);
        HandlerLoot.lootHandler().addLoot("pyramidDesertyChest", cobaltHelm, 1, 5, 1);
        HandlerLoot.lootHandler().addLoot("pyramidDesertyChest", cobaltChest, 1, 5, 1);
        HandlerLoot.lootHandler().addLoot("pyramidDesertyChest", cobaltLegs, 1, 5, 1);
        HandlerLoot.lootHandler().addLoot("pyramidDesertyChest", cobaltBoots, 1, 5, 1);

        HandlerLoot.lootHandler().addLoot("pyramidJungleChest", blueDriftSteelIngot, 1, 1, 1);
        HandlerLoot.lootHandler().addLoot("pyramidJungleChest", blueCeladonIngot, 1, 1, 1);
        HandlerLoot.lootHandler().addLoot("pyramidJungleChest", greenCeladonIngot, 1, 2, 4);
        HandlerLoot.lootHandler().addLoot("pyramidJungleChest", blueDriftSteelSword, 1, 1, 1);
        HandlerLoot.lootHandler().addLoot("pyramidJungleChest", blueCeladonSword, 1, 1, 1);
        HandlerLoot.lootHandler().addLoot("pyramidJungleChest", greenCeladonSword, 1, 5, 1);
        HandlerLoot.lootHandler().addLoot("pyramidJungleChest", greenCeladonHelm, 1, 5, 1);
        HandlerLoot.lootHandler().addLoot("pyramidJungleChest", greenCeladonChest, 1, 5, 1);
        HandlerLoot.lootHandler().addLoot("pyramidJungleChest", greenCeladonLegs, 1, 5, 1);
        HandlerLoot.lootHandler().addLoot("pyramidJungleChest", greenCeladonBoots, 1, 5, 1);
