...
public class ArsenicRecipes
{
    ...
    public static void doArsenicRecipes()
    {
        ...
        FusionRecipes.smelting().addSmelting(new ItemStack(CoreHelper.coreContent.copperIngot), new ItemStack(ArsenicAndLace.arsenicIngot), new ItemStack(Item.dyePowder, 1, 1), new ItemStack(ArsenicAndLace.smallArsenideBronzeChunkItem), 4.0F);
        FusionRecipes.smelting().addSmelting(new ItemStack(CoreHelper.coreContent.copperIngot), new ItemStack(ArsenicAndLace.arsenicIngot), new ItemStack(Item.rottenFlesh), new ItemStack(ArsenicAndLace.mediumArsenideBronzeChunkItem), 6.0F);
        FusionRecipes.smelting().addSmelting(new ItemStack(CoreHelper.coreContent.copperIngot), new ItemStack(ArsenicAndLace.arsenicIngot), new ItemStack(Item.redstone), new ItemStack(ArsenicAndLace.largeArsenideBronzeChunkItem), 15.0F);
