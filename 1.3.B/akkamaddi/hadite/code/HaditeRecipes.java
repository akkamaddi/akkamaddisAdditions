...
public class HaditeRecipes
{
    ...
    public static void doHaditeRecipes()
    {
        ...
        FusionRecipes.smelting().addSmelting(new ItemStack(CoreHelper.coreContent.tinIngot), new ItemStack(HaditeCoalCore.haditeCoalIngot), new ItemStack(Item.coal, 1, WILDCARD_VALUE), new ItemStack(HaditeCoalCore.largeGestankenzinnChunkItem), 5.0F);
        ...
        if (HaditeCoalCore.enableRecycling) {
            ...
            // recycle your Onyx
            FusionRecipes.smelting().addSmelting(new ItemStack(CoreHelper.coreContent.onyxHelm, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack), new ItemStack(HaditeCoalCore.haditeCoalIngot), new ItemStack(CoreHelper.coreContent.onyxOre), 20.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(CoreHelper.coreContent.onyxChest, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack, 2, 0), new ItemStack(HaditeCoalCore.haditeCoalIngot, 2, 0), new ItemStack(CoreHelper.coreContent.onyxOre, 2, 0), 40.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(CoreHelper.coreContent.onyxLegs, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack, 2, 0), new ItemStack(HaditeCoalCore.haditeCoalIngot, 2, 0), new ItemStack(CoreHelper.coreContent.onyxOre, 2, 0), 40.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(CoreHelper.coreContent.onyxBoots, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack), new ItemStack(HaditeCoalCore.haditeCoalIngot), new ItemStack(CoreHelper.coreContent.onyxOre), 20.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(CoreHelper.coreContent.onyxSword, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack), new ItemStack(HaditeCoalCore.haditeCoalIngot), new ItemStack(CoreHelper.coreContent.onyxOre), 20.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(CoreHelper.coreContent.onyxShovel, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack), new ItemStack(HaditeCoalCore.haditeCoalIngot), new ItemStack(CoreHelper.coreContent.onyxOre), 20.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(CoreHelper.coreContent.onyxPick, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack), new ItemStack(HaditeCoalCore.haditeCoalIngot), new ItemStack(CoreHelper.coreContent.onyxOre), 20.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(CoreHelper.coreContent.onyxAxe, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack), new ItemStack(HaditeCoalCore.haditeCoalIngot), new ItemStack(CoreHelper.coreContent.onyxOre), 20.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(CoreHelper.coreContent.onyxHoe, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack), new ItemStack(HaditeCoalCore.haditeCoalIngot), new ItemStack(CoreHelper.coreContent.onyxOre), 20.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(CoreHelper.coreContent.onyxBow, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack), new ItemStack(HaditeCoalCore.haditeCoalIngot), new ItemStack(CoreHelper.coreContent.onyxOre), 20.0F);
            // extra Onyx recycling
            FusionRecipes.smelting().addSmelting(new ItemStack(CoreHelper.coreContent.onyxDoorItem, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack), new ItemStack(HaditeCoalCore.haditeCoalIngot), new ItemStack(CoreHelper.coreContent.onyxOre), 20.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(CoreHelper.coreContent.onyxRod, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack), new ItemStack(HaditeCoalCore.haditeCoalIngot), new ItemStack(CoreHelper.coreContent.onyxOre), 20.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(CoreHelper.coreContent.onyxShears, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack), new ItemStack(HaditeCoalCore.haditeCoalIngot), new ItemStack(CoreHelper.coreContent.onyxOre), 20.0F);
            FusionRecipes.smelting().addSmelting(new ItemStack(CoreHelper.coreContent.onyxFurnace, 1, WILDCARD_VALUE), new ItemStack(Block.netherrack), new ItemStack(HaditeCoalCore.haditeCoalIngot), new ItemStack(CoreHelper.coreContent.onyxOre, 2, 0), 40.0F);
        }
    }
}
